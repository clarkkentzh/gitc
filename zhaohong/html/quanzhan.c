...
int main(int argc,const char * argv[]){
  ...
  printf("<table><tr><th>HTML4</th><th>HTML5</th></tr>");
  printf("<tr><td>单一标记性语言</td><td>增加了新元素，例如有画图元素，多媒体元素等。</td></tr>");
  printf("<tr><td>程序接口DOM</td><td>增加了列多的API接口，如：离线数据库存储，文档编辑，拖拽控制等。</td></tr><table>");
  printf("<p>编程语言：</p>");
  printf("<table><tr><th>HTML4</th><th>HTML5</th></tr>");
  printf("<tr><td>前端：HTML,CSS,JavaScript</td><td>JavaScript</td></tr>");
  printf("<tr><td>后端：PHP,C,Perl等</td><td>JavaScript</td></tr></table>");
  printf("<p>数据库：</p>");
  printf("<table><tr><th>HTML4</th><th>HTML5</th></tr>");
  printf("<tr><td>关系型数据库，mysql等</td><td>非关系型数据库，如MongoDB</td></tr></table>");
  printf("<p>服务器的架：</p>");
  printf("<table><tr><th>HTML4</th><th>HTML5</th></tr>");
  printf("<tr><td>Linux + mysql + php + apache</td><td>Docker + NodeJS or Meteor</td></tr></table>\n");
